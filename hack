...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>DANGKHOI chào ae<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Hãy sử dụng Fluxus để có trải nghiệm tốt!!<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Theo dõi tôi ở tiktok để cập nhật thông tin mới nhất nhé<Color=/>"):Display()
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>follow kênh tôi để xem video mới nhất nhé<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "DANGKHOI", HidePremium = false, IntroText = "DANGKHOI⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
OrionLib:MakeNotification({
    Name = "DANGKHOI",
    Content = "đợi hack load config rồi mới sài nha",
    Image = "rbxassetid://8192162908",
    Time = 10
})
...
W:AddLabel("PHÁT TRIỂN BỞI Đăng Khôi")
W:AddLabel("DANGKHOI SCRIPT")
W:AddLabel("DANGKHOI")
local Section = W:AddSection({
    Name = "Status"
})
...
M:AddToggle({
    Name = "TỰ ĐỘNG FARM THÔNG THẠO TAQ",
    Default = false,
    Flag = "Mastery",
    Save = true,
    Callback = function(Value)
...
IQ:AddToggle({
    Name = "Triệu hồi và tìm đảo bí ẩn",
    Default = false,
    Flag = "Auto Mirrage",
    Save = true,
    Callback = function(Value)
...
R:AddButton({
    Name = "dịch chuyển tới bánh răng",
    Callback = function()
        _G.TweenMGear = Value
